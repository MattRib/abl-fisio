  ...
  return (
    <div className="fixed bottom-4 right-4 z-[9999] md:hidden">
      <a
        ...
        onClick={handleClick}
        className="relative flex items-center justify-center w-14 h-14 bg-primary hover:bg-accent rounded-full shadow-lg hover:shadow-xl transition-all duration-300 tap-feedback group"
